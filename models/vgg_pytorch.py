...
class VGG_IMAGE(nn.Module):
  ...
  def forward(self, x, OF=None):
    if self.OF_option.lower()=='horizontal': dim=3
    else: dim=2
...
def vgg16(pretrained='', OF_option='None', **kwargs):
  ...
  #====================================================================================================#
    ...
    if pretrained:
      model_zoo_['classifier.0.weight'] = model_zoo_['classifier.0.weight'].repeat(1,2)
      model.load_state_dict(model_zoo_)    
  ...
  #====================================================================================================#
    ...
    if pretrained:
      model_zoo_['features.0.weight'] = model_zoo_['features.0.weight'].repeat(1,2,1,1)
      model.load_state_dict(model_zoo_)   
  ...
  #====================================================================================================#
    ...
    if pretrained:
      ...
      conv_of_params = {k.replace('features', 'features_of'): v for k,v in model_zoo_.iteritems() if 'features' in k}
  ...
  #====================================================================================================#
    ...
    if pretrained:
      ...
      conv_rgb_params = {k.replace('features', 'features_rgb'): v for k,v in model_zoo_.iteritems() if 'features' in k}
      model_zoo_2.update(conv_rgb_params)
      fc_rgb_params = {k.replace('classifier', 'classifier_rgb'): v for k,v in model_zoo_.iteritems() if 'classifier.0' in k}
      model_zoo_2.update(fc_rgb_params)

      conv_of_params = {k.replace('features', 'features_of'): v for k,v in model_zoo_.iteritems() if 'features' in k}
      model_zoo_2.update(conv_of_params)
      fc_of_params = {k.replace('classifier', 'classifier_of'): v for k,v in model_zoo_.iteritems() if 'classifier.0' in k}
      model_zoo_2.update(fc_of_params)

      
      model_zoo_2['classifier.0.weight'] = model_zoo_['classifier.3.weight'].repeat(1,2)
  ...
  #====================================================================================================#
    ...
    if pretrained:
      ...
      conv_rgb_params = {k.replace('features', 'features_rgb'): v for k,v in model_zoo_.iteritems() if 'features' in k}
      model_zoo_2.update(conv_rgb_params)
      fc_rgb_params = {k.replace('classifier', 'classifier_rgb'): v for k,v in model_zoo_.iteritems() if 'classifier.0' in k or 'classifier.3' in k}
      model_zoo_2.update(fc_rgb_params)

      conv_of_params = {k.replace('features', 'features_of'): v for k,v in model_zoo_.iteritems() if 'features' in k}
      model_zoo_2.update(conv_of_params)
      fc_of_params = {k.replace('classifier', 'classifier_of'): v for k,v in model_zoo_.iteritems() if 'classifier.0' in k or 'classifier.3' in k}
      model_zoo_2.update(fc_of_params)

      model_zoo_2['classifier.0.weight'] = model_zoo_['classifier.6.weight'].repeat(1,2)
